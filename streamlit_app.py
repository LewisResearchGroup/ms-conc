...
def display_button():
    ...
    if display_instructions == 'Show Instructions':
        st.markdown("""
         ...
         ######     Please make sure that the file names for standards and compound names in the standards concentrations file and peaklist data file are the same. Remove any compounds that are not in both the standards concentrations file and peaklist data file.
         """)
        st.write('''         
